...
WAR_NAME="form-handling-jakarta-1.0-SNAPSHOT.war"  # change this to your actual WAR file name
...
echo "open in browser: http://localhost:8080/${WAR_NAME%.war}/contact.html"
